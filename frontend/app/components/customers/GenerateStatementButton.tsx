...
// lib/dates.ts documents this exact anti-pattern and provides
// toCalendarDateString specifically to avoid it. For a UTC+ timezone
// (this app is Indonesian/id-ID), opening this dialog between local
// midnight and ~offset hours rolled every preset and default date back
// one calendar day.
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-md shadow-lg w-full max-w-sm p-4">
            <div className="flex items-center justify-between mb-3">
              <h2 className="font-bold text-lg">{t('sales.statementNew.statementForCustomer', { name: customerName })}</h2>
            ...
            >
              {t('sales.statementNew.generateShort')}
            </button>
          </div>
        </div>
      )}
